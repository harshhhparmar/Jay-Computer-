      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 font-medium">
            ₹5 Lakh Free Medical Treatment. Quick processing at Jay Computer. / ₹5 લાખની મફત તબીબી સારવાર. જય કોમ્પ્યુટર ખાતે ઝડપી કામગીરી.
          </p>
        </motion.div>
        ...
        >
          <div className="prose prose-lg prose-indigo max-w-none text-slate-700">
            <p className="lead text-xl mb-8">
              Don’t wait for a medical emergency. Get your Ayushman (PM-JAY) card and ABHA ID created today at Jay Computer, Halvad’s most trusted CSC center. We ensure your application is error-free so you get your benefits without any hassle. / તબીબી કટોકટીની રાહ ન જુઓ. આજે જ જય કોમ્પ્યુટર ખાતે તમારું આયુષ્માન (PM-JAY) કાર્ડ અને ABHA ID કઢાવો, જે હળવદનું સૌથી વિશ્વસનીય CSC સેન્ટર છે. અમે ખાતરી કરીએ છીએ કે તમારી અરજી ભૂલ-મુક્ત છે જેથી તમને કોઈ પણ મુશ્કેલી વિના લાભ મળે.
            </p>
            ...
            <ul className="space-y-4 mb-8">
              {[
                { en: "Aadhaar Card (Linked with Mobile Number)", gu: "આધાર કાર્ડ (મોબાઈલ નંબર સાથે લિંક કરેલ)" },
                { en: "Ration Card (NFSA)", gu: "રેશન કાર્ડ (NFSA)" },
                { en: "Income Certificate (if required)", gu: "આવકનો દાખલો (જો જરૂરી હોય તો)" }
              ].map((doc, idx) => (
