...
export const services: Service[] = [
  ...
  // 3. Student / Labour / Scholarship Services
  {
    ...
    titleGu: 'ડિજિટલ ગુજરાત સ્કોલરશીપ',
    iconName: 'GraduationCap',
    descriptionEn: 'Assistance in filling Digital Gujarat Scholarship forms.',
    descriptionGu: 'ડિજિટલ ગુજરાત સ્કોલરશીપના ફોર્મ ભરવા.',
  ...
  },
  {
    ...
    categoryEn: 'Student / Labour / Scholarship',
    categoryGu: 'વિદ્યાર્થી / શ્રમિક કાડૅ / સ્કોલરશીપ',
    titleEn: 'E-Nirman Scholarship',
    titleGu: 'ઈ-નિર્માણ શિક્ષણ સહાય યોજના',
    iconName: 'GraduationCap',
    descriptionEn: 'Education assistance (scholarship) for children of E-Nirman (Shramyogi) Card holders.',
    descriptionGu: 'ઈ-નિર્માણ કાર્ડ (શ્રમયોગી કાર્ડ) ધારકોના બાળકો માટે શિક્ષણ સહાય યોજના (સ્કોલરશીપ).',
    documentsEn: [
      'E-Nirman Card',
      'Original Bonafide Certificate of Student',
      'Father\'s Aadhaar Card',
      'Student\'s Aadhaar Card',
      'Bank Passbook',
      'Previous Year Marksheet',
      'Ration Card',
      'Hostel/Institute Certificate (If living in hostel)',
      'Passport size photos of student and parent',
      'Affidavit (Sogandnamu)'
    ],
    documentsGu: [
      'ઈ નિર્માણકાર્ડ',
      'શાળા/કોલેજ/સંસ્થાના વિદ્યાર્થીનું ઓરિજનલ બોનોફાઈડ સર્ટીફિકેટ',
      'પિતાનું આધારકાર્ડ',
      'વિદ્યાર્થીનું આધારકાર્ડ',
      'બેંકની પાસબુક',
      'ગતવર્ષની માર્કશીટ',
      'રેશનકાર્ડ',
      'હોસ્ટેલ/સંસ્થાનું સહી સિક્કાવાળું પ્રમાણપત્ર (હોસ્ટેલમાં રહેતા હોય તો)',
      'પાસપોર્ટ સાઈઝના ફોટા વિદ્યાર્થી વાલી બંનેના',
      'સોગંદનામું'
    ],
    popular: true
  },
  {
    ...
    titleGu: 'ઈ-શ્રમ કાર્ડ',
    iconName: 'HardHat',
    descriptionEn: 'New registration and updates for E-Shram Cards for unorganized workers.',
    descriptionGu: 'શ્રમિકો માટે નવું ઈ-શ્રમ કાર્ડ કઢાવવા માટેનું કામ.',
    documentsEn: ['Aadhaar Card', 'Mobile Number Linked with Aadhaar', 'Bank Account'],
    documentsGu: ['આધાર કાર્ડ', 'આધાર સાથે લિંક કરેલ મોબાઈલ નંબર', 'બેંક ખાતું']
  },
  {
    id: 'e-nirman-card',
    categoryEn: 'Student / Labour / Scholarship',
    categoryGu: 'વિદ્યાર્થી / શ્રમિક કાડૅ / સ્કોલરશીપ',
    titleEn: 'E-Nirman Card',
    titleGu: 'ઈ-નિર્માણ કાર્ડ (શ્રમયોગી કાર્ડ)',
    iconName: 'HardHat',
    descriptionEn: 'Provides construction and unorganized laborers with access to over 25 social welfare schemes. Available to workers aged 18 to 60 who have worked at least 90 days in the last year.',
    descriptionGu: 'બાંધકામ શ્રમિકો માટે ઈ-નિર્માણ કાર્ડ, જેમાં 25 થી વધુ સરકારી સહાય યોજનાઓનો લાભ મળે છે.',
    documentsEn: ['Aadhaar Card', 'Bank Passbook', 'Ration Card', 'Passport Size Photo'],
    documentsGu: ['આધાર કાર્ડ', 'બેંક પાસબુક', 'રેશનકાર્ડ', 'પાસપોર્ટ સાઇઝ ફોટો']
  },
